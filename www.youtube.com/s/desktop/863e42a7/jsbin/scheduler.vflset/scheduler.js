...
*/
    ...
    function ha(a, b, c) {
        if (!c) return c = void 0 === c, -H(X(), a, b, c); var d = window.setTimeout(function () { var e = H(X(), a, b); Q[d] = e }, c);
        return d
    }
